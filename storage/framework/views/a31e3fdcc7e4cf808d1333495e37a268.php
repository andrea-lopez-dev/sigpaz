...
<body>
    <div class="header">
        <h1>SIGPAZ</h1>
        <p>Reporte de Distribución por Edad</p>
        <p>Fecha: <?php echo e($fecha_exportacion); ?></p>
    </div>

    <div class="section-title">📊 Distribución por Rangos de Edad</div>
...
<?php /**PATH C:\original SIGPAZ\justicia-paz-backend\sigpaz-backend\resources\views/pdfs/reporte_edad.blade.php ENDPATH**/ ?>