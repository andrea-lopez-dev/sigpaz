...
class CrearPersonaRequest extends FormRequest
{
    ...
    {
        return [
            'tipo_documento_id' => ['required', 'integer', 'exists:tipo_documento,tipo_documento_id'],
            'numero_documento' => [
                'required',
                'string',
                'max:20',
                function ($attribute, $value, $fail) {
                    ...
                    if ($exists) {
                        $fail('Ya existe una persona con este tipo y número de documento.');
                    }
                }
            ],
            ...
            'estado_civil_id' => ['nullable', 'integer', 'exists:estado_civil,estado_civil_id'],
            ...
            'tipo_vinculo_id' => ['nullable', 'integer', 'exists:tipo_vinculo,tipo_vinculo_id'],
