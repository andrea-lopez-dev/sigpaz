...
class TipoConflicto extends Model implements CatalogoInterface
{
    use HasFactory, HasBooleanAttributes;

    protected $table = 'tipoconflicto';
    protected $primaryKey = 'tipo_conflicto_id';
    ...
    {
        return $this->hasMany(Denuncia::class, 'tipo_conflicto_id', 'tipo_conflicto_id');
    }
    ...
    public function eliminarLogico(): bool
    {
        if (!$this->puedeEliminar()) {
            throw new \Exception('No se puede eliminar porque tiene denuncias asociadas');
        }
