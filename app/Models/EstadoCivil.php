...
class EstadoCivil extends Model implements CatalogoInterface
{
    ...
    {
        return $this->hasMany(Persona::class, 'estado_civil_id', 'estado_civil_id');
    }

    public function denunciantes(): HasMany
    {
        return $this->hasMany(Denunciante::class, 'estado_civil_id', 'estado_civil_id');
    }

    public function imputados(): HasMany
    {
        return $this->hasMany(Imputado::class, 'estado_civil_id', 'estado_civil_id');
    }
    ...
    public function eliminarLogico(): bool
    {
        if (!$this->puedeEliminar()) {
            throw new \Exception('No se puede eliminar porque tiene registros asociados');
        }
    ...
    public function puedeEliminar(): bool
    {
        return !$this->persona()->exists() && 
               !$this->denunciantes()->exists() && 
               !$this->imputados()->exists();
    }
}