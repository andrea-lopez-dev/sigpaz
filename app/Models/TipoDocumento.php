...
class TipoDocumento extends Model implements CatalogoInterface
{
    ...
    {
        return $this->hasMany(Persona::class, 'tipo_documento_id', 'tipo_documento_id');
    }

    public function denunciantes()
    {
        return $this->hasMany(Denunciante::class, 'tipo_documento_id', 'tipo_documento_id');
    }

    public function imputados()
    {
        return $this->hasMany(Imputado::class, 'tipo_documento_id', 'tipo_documento_id');
    }
