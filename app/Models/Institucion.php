...
class Institucion extends Model implements CatalogoInterface
{
    ...
    {
        return $this->hasMany(Remision::class, 'institucion_id', 'institucion_id');
    }

    public function sentencias(): HasMany
    {
        return $this->hasMany(Sentencia::class, 'institucion_remitida_id', 'institucion_id');
    }
    ...
    {
        return !$this->remisiones()->exists() && !$this->sentencias()->exists();
    }
}