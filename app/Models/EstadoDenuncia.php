...
class EstadoDenuncia extends Model implements CatalogoInterface
{
    use HasFactory, HasBooleanAttributes;

    protected $table = 'estadodenuncia';
    protected $primaryKey = 'estado_denuncia_id';
    ...
    {
        return $this->hasMany(Denuncia::class, 'estado_denuncia_id', 'estado_denuncia_id');
    }
