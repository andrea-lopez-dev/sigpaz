...
class Genero extends Model implements CatalogoInterface
{
    ...
    {
        return $this->hasMany(Persona::class, 'genero_id', 'genero_id');
    }

    public function denunciantes(): HasMany
    {
        return $this->hasMany(Denunciante::class, 'genero_id', 'genero_id');
    }

    public function imputados(): HasMany
    {
        return $this->hasMany(Imputado::class, 'genero_id', 'genero_id');
    }
