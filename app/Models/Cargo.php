...
class Cargo extends Model implements CatalogoInterface
{
    ...
    {
        return $this->hasMany(Personal::class, 'cargo_id', 'cargo_id');
    }
    ...
    public function eliminarLogico(): bool
    {
        if (!$this->puedeEliminar()) {
            throw new \Exception('No se puede eliminar porque tiene personal asociado');
        }
