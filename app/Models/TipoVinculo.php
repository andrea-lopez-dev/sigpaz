...
class TipoVinculo extends Model implements CatalogoInterface
{
    use HasFactory, HasBooleanAttributes;

    protected $table = 'tipovinculo';
    protected $primaryKey = 'tipo_vinculo_id';
    ...
    {
        return $this->hasMany(persona::class, 'tipo_vinculo_id', 'tipo_vinculo_id');
    }
    ...
    public function eliminarLogico(): bool
    {
        if (!$this->puedeEliminar()) {
            throw new \Exception('No se puede eliminar porque tiene imputados asociados');
        }
